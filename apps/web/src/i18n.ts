...
const zh = {
	...
	"settings.model.enabledHint": "开启后按下方间隔自动巡检项目。",
	...
	"work.inspection.retryHint": "上次巡检失败。请检查设置和模型服务，然后点击立即巡检重试；定时巡检开启时也会按周期再试。",
	"work.inspect": "立即巡检",
...
const en: Record<MsgKey, string> = {
	...
	"settings.model.enabledHint": "Inspect projects automatically at the interval below.",
	...
	"work.inspection.retryHint": "The last inspection failed. Check settings and the model provider, then inspect again; scheduled inspections also resume at the configured interval.",
